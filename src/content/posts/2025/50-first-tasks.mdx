...
<Source lang="Markdown" filename=".github/copilot-instructions.md">
Always greet the user as Yoda would greet young Skywalker.
</Source>

And then try that in a new VSCode project:

<Img src="/content/images/2026/02/copilot-instructions_md_---_article.jpg" alt="Copilot's first action is to read its instructions!" />
...
<Img src="/content/images/2026/02/ARCHITECTURE_md_---_article.jpg" alt="docs/memory-bank/ARCHITECTURE.md" />
...
<Img src="/content/images/2026/02/copilot-instructions-step02-3.gif" alt="Load Memory Bank in memory" />
...
<Quote>Backlog Oriented Development</Quote>

The backlog section deserves a thorough examination.

<Img src="/content/images/2026/02/BACKLOG_md_---_article.jpg" alt="docs/backlog/BACKLOG.md" />
...
<Img src="/content/images/2026/02/init-node-project_md_---_article.jpg" alt="backlog & task definition" />
...
<Quote>Use the Backlog, Luke</Quote>
...
<Img src="/content/images/2026/02/BACKLOG_md_---_article-1.jpg" alt="set the current task" />

* * *

<Quote>\> plan task</Quote>
...
<Img src="/content/images/2026/02/copilot-instructions-step04-plan.gif" alt="plan task" />

<Quote>Review carefully</Quote>
...
<Img src="/content/images/2026/02/copilot-instructions-step04-execute.gif" alt="execute task" />
...
<Img src="/content/images/2026/02/Screenshot_2025-07-11__12_40.jpg" alt="✅ task successfully executed!" />
...
<Source lang="Markdown" filename="task review prompt">
- Review and complete the task's documentation
- Update the Memory Bank's files
- Mark the task as completed in the backlog
</Source>

<Img src="/content/images/2026/02/copilot-instructions-step04-review.gif" alt="review and document the task" />
...
<Img src="/content/images/2026/02/task-wrap-up.jpg" alt="task wrap up output" />
