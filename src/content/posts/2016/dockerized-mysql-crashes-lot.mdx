...
This blog is being hosted on a [5$/mo DigitalOcean droplet](https://m.do.co/c/0a72735ae62e) and it is served as <GitHubRepo url="https://github.com/marcopeg/humble-cli" /> project. **Docker gave me pure freedom in my technology stack** for a reasonable 60$/year price. I like it, a lot.
...
<Img src="/content/images/2021/11/image-16.png" alt="" />
...
Anyway I really hate the idea to spend money on MAMP Pro like I used to do in the past, today we have [Docker](http://docker.com/) and everything should be fast and easy thanks to tools like [Docker Compose](https://docs.docker.com/compose/) and <GitHubRepo url="https://github.com/marcopeg/humble-cli" />.
...
<Img src="/content/images/2021/11/image-17.png" alt="" />
...
<Img src="/content/images/2021/11/image-18.png" alt="" />
...
<Img src="/content/images/2021/11/image-19.png" alt="" />
