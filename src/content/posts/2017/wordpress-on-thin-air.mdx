...
<Img src="/content/images/2021/11/image-22.png" alt="" />
...
**NOTE:** the code above is not complete. The scope of this article is to understand the problem and the solution. If you want all the juicy details <GitHubRepo url="https://github.com/marcopeg/marcopeg" />.
...
**NOTE1:** the `server-configs-nginx/mime.types` file please refer to <GitHubRepo url="https://github.com/h5bp/server-configs-nginx" /> repository. That dude knows his stuff.
